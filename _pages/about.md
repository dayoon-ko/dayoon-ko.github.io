...
<div class="pub_item" style="display:inline-flex; padding-bottom:20px;">
  ...
  <div class="pub_detail" style="margin-left:10px; max-width:400px">
    ...
    <p style="font-size:15px; margin-bottom:2px">By proposing QA and dialogue benchmarks that are continuously and automatically updated, we evaluate the LLM's ability to handle dynamic knowledge. We train a classifier using the last hidden state of the LLM to assess its confience, enabling RAG systems to adapt to new knowledge without retraining.</p>
  </div>
</div>
